  ...
  return (
    <View className="flex-1 bg-[#E6F2ED] px-4 py-6">
      ...
      <View className="flex-row items-center justify-between mb-4">
        ...
        <Text className="text-lg font-semibold text-gray-700">Pay with <Text className="text-green-600">Card</Text></Text>
      ...
      <View className="bg-white p-4 rounded-lg shadow mb-6">
        <Text className="text-lg font-bold text-gray-800">Total Amount to Pay</Text>
        <Text className="text-xl font-bold text-green-600">${totalAmount}</Text>
      </View>
