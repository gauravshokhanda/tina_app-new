  ...
  return (
    <View className="flex-1 bg-[#E6F2ED]">
      ...
      <ScrollView className="px-4 mt-6 mb-20">
        ...
        <TouchableOpacity onPress={() => router.push('/EditProfile')} className="flex-row items-center justify-between py-4 border-b border-gray-200">
        ...
        {/* Help & Support */}
        <TouchableOpacity onPress={() => router.push('/Help')} className="flex-row items-center justify-between py-4 border-b border-gray-200">
          <View className="flex-row items-center">
        ...
        {/* Privacy Policy */}
        <TouchableOpacity onPress={() => router.push('/Privacy')} className="flex-row items-center justify-between py-4 border-b border-gray-200">
          <View className="flex-row items-center">
