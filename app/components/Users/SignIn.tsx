      ...
      <View className="flex-1 justify-center gap-8">
        ...
        <View>
          ...
          <Text className="text-center text-gray-500">
            ...
            <Text onPress={() => router.push('/Screens/Terms')} className="text-green-500 font-bold text-sm">Terms of Service</Text> and{" "}
            <Text onPress={() => router.push('/Screens/Privacy')} className="text-green-500 font-bold text-sm">Privacy Policy</Text>
          </Text>
        </View>
      </View>
    </View>
