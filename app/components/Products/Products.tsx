...
interface Product {
    ...
    return (
        ...
        <View className="flex-row items-center justify-between px-4 py-4">
            <TouchableOpacity onPress={() => router.push('/Screens/Welcome')} className="p-2 rounded-full bg-[#64CA96E5]">
            <MaterialIcons name="arrow-left" size={20} color="white" />
            </TouchableOpacity>
            <Text className="text-lg font-semibold text-gray-700">
            <Text className="text-green-600">Products</Text> and Services
            </Text>
            <TouchableOpacity onPress={() => router.push({ pathname: "/components/Cart/Cart", params: { cart: encodeURIComponent(JSON.stringify(cart)) } })}>
        ...
        <FlatList
            ...
            <View className="bg-white p-2 m-2 rounded-lg items-center w-[45%] shadow-md">
                ...
                <TouchableOpacity onPress={() => router.push({ pathname: "/constants/Item", params: { productId: item.id } })} className="items-center">
