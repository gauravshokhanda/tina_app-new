...
import { View, Text, TextInput, TouchableOpacity, ScrollView, Alert, Image, Linking } from "react-native";
        ...
        <Entypo name="phone" size={24} color="#64CA96E5" />
            ...
            <ScrollView className="px-4 pb-20">
                ...
                <View className="items-center mb-6">
                    ...
                    <Text className="text-sm text-gray-600">Experienced Seller | 5-Star Rating</Text>
                </View>
                ...
                >
                    ...
                    <Text className="text-white font-bold ml-2">Contact via WhatsApp</Text>
                </TouchableOpacity>

                {/* Seller Information */}
                <View className="bg-white p-4 rounded-lg shadow mb-4">
                    <Text className="text-lg font-bold text-gray-800 mb-2">Seller Information</Text>
                    <Text className="text-gray-600 mb-2">Seller Name: Manish Sirohi</Text>
                    <Text className="text-gray-600 mb-2">Email: Sirohi.manish023@example.com</Text>
