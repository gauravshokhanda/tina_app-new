...
const LoggedInAccount = () => {
  ...
  const { name, user_email, token } = useSelector(
  ...
  return (
    <SafeAreaView className="flex-1 bg-[#E6F2ED] px-4 pb-20">
      ...
      <Animated.View
        ...
        className="flex-row items-center justify-between mt-6 mx-3"
      >
        <TouchableOpacity
      ...
      >
        ...
        <Text className="text-gray-600">
          {loading ? "Fetching..." : userData.email}
        </Text>
      </Animated.View>

      {/* Menu Sections */}
      <ScrollView className="mt-6 space-y-4 px-3">
        {/* Manage Section */}
          ...
          <View className="bg-white rounded-lg p-4 space-y-2 shadow-md mt-2">
            ...
            >
              <View className="flex-row items-center">
                ...
                <Text className="ml-3 text-gray-800 text-lg">
                  My Transactions
                </Text>
              </View>
              <MaterialIcons name="chevron-right" size={22} color="gray" />
        ...
        <Animated.View entering={FadeInUp.duration(500).delay(500)}>
          <TouchableOpacity
            ...
            className="bg-[#64CA96E5] py-3 rounded-lg flex-row items-center justify-center mt-8 mx-4 shadow-md"
          >
